...
public enum ErrorCode {
    ...
    INVALID_SHOP_NAME(1014, "Shop name must be at least {min} characters", HttpStatus.BAD_REQUEST),
    INVALID_FULL_NAME(1014, "Full name must be at least {min} characters", HttpStatus.BAD_REQUEST),
